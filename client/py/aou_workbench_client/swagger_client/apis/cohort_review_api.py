...
class CohortReviewApi(object):
    ...
    def create_participant_cohort_annotation(self, workspace_namespace, workspace_id, cohort_id, participant_id, request, **kwargs):
        """
        This endpoint will create a ParticipantCohortAnnotation.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.create_participant_cohort_annotation(workspace_namespace, workspace_id, cohort_id, participant_id, request, async=True)
        >>> result = thread.get()

        :param async bool
        :param str workspace_namespace: The Workspace namespace (required)
        :param str workspace_id: The Workspace ID (a.k.a. the workspace's Firecloud name) (required)
        :param int cohort_id: Cohort Review ID (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.create_participant_cohort_annotation_with_http_info(workspace_namespace, workspace_id, cohort_id, participant_id, request, **kwargs)
        else:
            (data) = self.create_participant_cohort_annotation_with_http_info(workspace_namespace, workspace_id, cohort_id, participant_id, request, **kwargs)
            return data

    def create_participant_cohort_annotation_with_http_info(self, workspace_namespace, workspace_id, cohort_id, participant_id, request, **kwargs):
        """
        This endpoint will create a ParticipantCohortAnnotation.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.create_participant_cohort_annotation_with_http_info(workspace_namespace, workspace_id, cohort_id, participant_id, request, async=True)
        >>> result = thread.get()
        ...
        all_params = ['workspace_namespace', 'workspace_id', 'cohort_id', 'participant_id', 'request']
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        return self.api_client.call_api('/v1/workspaces/{workspaceNamespace}/{workspaceId}/review/{cohortReviewId}/participants/{participantId}/annotations', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def delete_participant_cohort_annotation(self, workspace_namespace, workspace_id, cohort_id, participant_id, annotation_id, **kwargs):
        """
        Deletes the ParticipantCohortAnnotation with the specified ID
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.delete_participant_cohort_annotation(workspace_namespace, workspace_id, cohort_id, participant_id, annotation_id, async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.delete_participant_cohort_annotation_with_http_info(workspace_namespace, workspace_id, cohort_id, participant_id, annotation_id, **kwargs)
        else:
            (data) = self.delete_participant_cohort_annotation_with_http_info(workspace_namespace, workspace_id, cohort_id, participant_id, annotation_id, **kwargs)
            return data

    def delete_participant_cohort_annotation_with_http_info(self, workspace_namespace, workspace_id, cohort_id, participant_id, annotation_id, **kwargs):
        """
        Deletes the ParticipantCohortAnnotation with the specified ID
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.delete_participant_cohort_annotation_with_http_info(workspace_namespace, workspace_id, cohort_id, participant_id, annotation_id, async=True)
        >>> result = thread.get()
        ...
        all_params = ['workspace_namespace', 'workspace_id', 'cohort_id', 'participant_id', 'annotation_id']
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        return self.api_client.call_api('/v1/workspaces/{workspaceNamespace}/{workspaceId}/review/{cohortReviewId}/participants/{participantId}/annotations/{annotationId}', 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get_participant_cohort_annotations(self, workspace_namespace, workspace_id, cohort_id, participant_id, **kwargs):
        """
        This endpoint will get a collection of ParticipantCohortAnnotations.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_participant_cohort_annotations(workspace_namespace, workspace_id, cohort_id, participant_id, async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.get_participant_cohort_annotations_with_http_info(workspace_namespace, workspace_id, cohort_id, participant_id, **kwargs)
        else:
            (data) = self.get_participant_cohort_annotations_with_http_info(workspace_namespace, workspace_id, cohort_id, participant_id, **kwargs)
            return data

    def get_participant_cohort_annotations_with_http_info(self, workspace_namespace, workspace_id, cohort_id, participant_id, **kwargs):
        """
        This endpoint will get a collection of ParticipantCohortAnnotations.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_participant_cohort_annotations_with_http_info(workspace_namespace, workspace_id, cohort_id, participant_id, async=True)
        >>> result = thread.get()
        ...
        all_params = ['workspace_namespace', 'workspace_id', 'cohort_id', 'participant_id']
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        return self.api_client.call_api('/v1/workspaces/{workspaceNamespace}/{workspaceId}/review/{cohortReviewId}/participants/{participantId}/annotations', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get_participant_cohort_status_with_http_info(self, workspace_namespace, workspace_id, cohort_id, cdr_version_id, participant_id, **kwargs):
        ...
        return self.api_client.call_api('/v1/workspaces/{workspaceNamespace}/{workspaceId}/review/{cohortId}/{cdrVersionId}/status/{participantId}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get_participant_cohort_statuses(self, workspace_namespace, workspace_id, cohort_id, cdr_version_id, **kwargs):
        ...
        :param str sort_column: Column upon which to sort (default is 'participantId')
        :param str sort_order: Sort direction (default is ascending)
        :param list[str] filter_column:
        :param list[str] filter_value:
        :return: CohortReview
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def get_participant_cohort_statuses_with_http_info(self, workspace_namespace, workspace_id, cohort_id, cdr_version_id, **kwargs):
        ...
        all_params = ['workspace_namespace', 'workspace_id', 'cohort_id', 'cdr_version_id', 'page', 'page_size', 'sort_column', 'sort_order', 'filter_column', 'filter_value']
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'filter_column' in params:
            query_params.append(('filterColumn', params['filter_column']))
            collection_formats['filterColumn'] = 'csv'
        if 'filter_value' in params:
            query_params.append(('filterValue', params['filter_value']))
            collection_formats['filterValue'] = 'csv'
        ...
        return self.api_client.call_api('/v1/workspaces/{workspaceNamespace}/{workspaceId}/review/{cohortId}/{cdrVersionId}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def update_participant_cohort_annotation(self, workspace_namespace, workspace_id, cohort_id, participant_id, annotation_id, request, **kwargs):
        """
        This endpoint will modify a ParticipantCohortAnnotation.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.update_participant_cohort_annotation(workspace_namespace, workspace_id, cohort_id, participant_id, annotation_id, request, async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.update_participant_cohort_annotation_with_http_info(workspace_namespace, workspace_id, cohort_id, participant_id, annotation_id, request, **kwargs)
        else:
            (data) = self.update_participant_cohort_annotation_with_http_info(workspace_namespace, workspace_id, cohort_id, participant_id, annotation_id, request, **kwargs)
            return data

    def update_participant_cohort_annotation_with_http_info(self, workspace_namespace, workspace_id, cohort_id, participant_id, annotation_id, request, **kwargs):
        """
        This endpoint will modify a ParticipantCohortAnnotation.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.update_participant_cohort_annotation_with_http_info(workspace_namespace, workspace_id, cohort_id, participant_id, annotation_id, request, async=True)
        >>> result = thread.get()
        ...
        all_params = ['workspace_namespace', 'workspace_id', 'cohort_id', 'participant_id', 'annotation_id', 'request']
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        return self.api_client.call_api('/v1/workspaces/{workspaceNamespace}/{workspaceId}/review/{cohortReviewId}/participants/{participantId}/annotations/{annotationId}', 'PUT',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def update_participant_cohort_status_with_http_info(self, workspace_namespace, workspace_id, cohort_id, cdr_version_id, participant_id, **kwargs):
        ...
        return self.api_client.call_api('/v1/workspaces/{workspaceNamespace}/{workspaceId}/review/{cohortId}/{cdrVersionId}/status/{participantId}', 'PUT',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
