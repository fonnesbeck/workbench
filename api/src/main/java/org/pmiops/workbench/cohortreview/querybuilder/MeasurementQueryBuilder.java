...
public class MeasurementQueryBuilder implements ReviewQueryBuilder {
  ...
  private static final String MEASUREMENTS_SQL_TEMPLATE =
    "select m.measurement_datetime as itemDate,\n" +
      ...
      "where m.person_id = @" + NAMED_PARTICIPANTID_PARAM + "\n" +
      "order by %s %s, measurement_id\n";
  ...
  private static final String MEASUREMENTS_SQL_COUNT_TEMPLATE =
  ...
  public String getCountQuery() {
    return this.MEASUREMENTS_SQL_COUNT_TEMPLATE;
  }
