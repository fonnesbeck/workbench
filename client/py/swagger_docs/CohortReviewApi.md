...
[**create_participant_cohort_annotation**](CohortReviewApi.md#create_participant_cohort_annotation) | **POST** /v1/workspaces/{workspaceNamespace}/{workspaceId}/review/{cohortReviewId}/participants/{participantId}/annotations | 
[**delete_participant_cohort_annotation**](CohortReviewApi.md#delete_participant_cohort_annotation) | **DELETE** /v1/workspaces/{workspaceNamespace}/{workspaceId}/review/{cohortReviewId}/participants/{participantId}/annotations/{annotationId} | 
...
[**get_participant_cohort_annotations**](CohortReviewApi.md#get_participant_cohort_annotations) | **GET** /v1/workspaces/{workspaceNamespace}/{workspaceId}/review/{cohortReviewId}/participants/{participantId}/annotations | 
[**get_participant_cohort_status**](CohortReviewApi.md#get_participant_cohort_status) | **GET** /v1/workspaces/{workspaceNamespace}/{workspaceId}/review/{cohortId}/{cdrVersionId}/status/{participantId} | 
[**get_participant_cohort_statuses**](CohortReviewApi.md#get_participant_cohort_statuses) | **GET** /v1/workspaces/{workspaceNamespace}/{workspaceId}/review/{cohortId}/{cdrVersionId} | 
[**update_participant_cohort_annotation**](CohortReviewApi.md#update_participant_cohort_annotation) | **PUT** /v1/workspaces/{workspaceNamespace}/{workspaceId}/review/{cohortReviewId}/participants/{participantId}/annotations/{annotationId} | 
[**update_participant_cohort_status**](CohortReviewApi.md#update_participant_cohort_status) | **PUT** /v1/workspaces/{workspaceNamespace}/{workspaceId}/review/{cohortId}/{cdrVersionId}/status/{participantId} | 
...
> ParticipantCohortAnnotation create_participant_cohort_annotation(workspace_namespace, workspace_id, cohort_id, participant_id, request)
...
workspace_namespace = 'workspace_namespace_example' # str | The Workspace namespace
workspace_id = 'workspace_id_example' # str | The Workspace ID (a.k.a. the workspace's Firecloud name)
cohort_id = 789 # int | Cohort Review ID
...
try: 
    api_response = api_instance.create_participant_cohort_annotation(workspace_namespace, workspace_id, cohort_id, participant_id, request)
    pprint(api_response)
except ApiException as e:
 ...
 **workspace_namespace** | **str**| The Workspace namespace | 
 **workspace_id** | **str**| The Workspace ID (a.k.a. the workspace&#39;s Firecloud name) | 
 **cohort_id** | **int**| Cohort Review ID | 
...
> EmptyResponse delete_participant_cohort_annotation(workspace_namespace, workspace_id, cohort_id, participant_id, annotation_id)
...
try: 
    api_response = api_instance.delete_participant_cohort_annotation(workspace_namespace, workspace_id, cohort_id, participant_id, annotation_id)
    pprint(api_response)
except ApiException as e:
...
> ParticipantCohortAnnotationListResponse get_participant_cohort_annotations(workspace_namespace, workspace_id, cohort_id, participant_id)
...
try: 
    api_response = api_instance.get_participant_cohort_annotations(workspace_namespace, workspace_id, cohort_id, participant_id)
    pprint(api_response)
except ApiException as e:
...
> CohortReview get_participant_cohort_statuses(workspace_namespace, workspace_id, cohort_id, cdr_version_id, page=page, page_size=page_size, sort_column=sort_column, sort_order=sort_order, filter_column=filter_column, filter_value=filter_value)
...
sort_column = 'participantId' # str | Column upon which to sort (default is 'participantId') (optional) (default to participantId)
sort_order = 'asc' # str | Sort direction (default is ascending) (optional) (default to asc)
filter_column = ['filter_column_example'] # list[str] |  (optional)
filter_value = ['filter_value_example'] # list[str] |  (optional)

try: 
    api_response = api_instance.get_participant_cohort_statuses(workspace_namespace, workspace_id, cohort_id, cdr_version_id, page=page, page_size=page_size, sort_column=sort_column, sort_order=sort_order, filter_column=filter_column, filter_value=filter_value)
    pprint(api_response)
except ApiException as e:
 ...
 **sort_column** | **str**| Column upon which to sort (default is &#39;participantId&#39;) | [optional] [default to participantId]
 **sort_order** | **str**| Sort direction (default is ascending) | [optional] [default to asc]
 **filter_column** | [**list[str]**](str.md)|  | [optional] 
 **filter_value** | [**list[str]**](str.md)|  | [optional] 
...
> ParticipantCohortAnnotation update_participant_cohort_annotation(workspace_namespace, workspace_id, cohort_id, participant_id, annotation_id, request)
...
try: 
    api_response = api_instance.update_participant_cohort_annotation(workspace_namespace, workspace_id, cohort_id, participant_id, annotation_id, request)
    pprint(api_response)
except ApiException as e:
