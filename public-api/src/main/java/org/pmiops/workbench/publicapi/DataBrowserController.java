...
import org.pmiops.workbench.model.SurveyMatchList;
...
public class DataBrowserController implements DataBrowserApiDelegate {
     ...
     * client representation (generated by Swagger).
     */
    private static final Function<QuestionConceptListResponse, org.pmiops.workbench.model.QuestionConceptListResponse>
            TO_CLIENT_QUESTION_CONCEPT_LIST_RESPONSE =
            new Function<QuestionConceptListResponse, org.pmiops.workbench.model.QuestionConceptListResponse>() {
                @Override
    ...
    @Override
    public ResponseEntity<SurveyMatchList> getSurveyMatch(String keyword){
        List<DbDomain> surveys=dbDomainDao.findByDbTypeAndAndConceptIdNotNull("survey");
        List<QuestionConceptListResponse> searchItems=new ArrayList<QuestionConceptListResponse>();
        SurveyMatchList surveyMatchList=new SurveyMatchList();
        for(DbDomain survey:surveys){

            Long surveyConceptId=survey.getConceptId();
            String stringSurveyConceptId=String.valueOf(surveyConceptId);

            List<QuestionConcept> questions = questionConceptDao.findSurveyQuestions(surveyConceptId);
            List<QuestionConcept> matchingQuestions=new ArrayList<QuestionConcept>();
        ...
        return ResponseEntity.ok(surveyMatchList);
    }
